...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowerAlph = string.ascii_lowercase + string.ascii_lowercase
        upperAlph = string.ascii_uppercase + string.ascii_uppercase

        for i in range(26):
            shiftDict[lowerAlph[i]] = lowerAlph[i+shift]

        for i in range(26):
            shiftDict[upperAlph[i]] = upperAlph[i+shift]
